  ...
  return (
    <>
      <h4 className="py-3 mb-4">
        <span className="text-muted fw-light">Forms /</span> Input groups
      </h4>
          ...
          <div className="card mb-4">
            ...
            <div className="card-body demo-vertical-spacing demo-only-element">
              ...
              <div className="form-password-toggle">
                <label className="form-label" for="basic-default-password12">
                  Password
                </label>
                <div className="input-group">
                  <input
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="card mb-4">
            ...
            <div className="card-body demo-vertical-spacing demo-only-element">
              <small className="text-light fw-medium d-block">
                Multiple inputs
              </small>
              <div className="input-group">
              ...
              <small className="text-light fw-medium d-block pt-3">
                Multiple addons
              </small>
              <div className="input-group">
                <span className="input-group-text">$</span>
