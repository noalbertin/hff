              ...
              <tbody>
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Heading 1</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Heading 2</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td>
                    <small className="text-light fw-medium">Heading 3</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td>
                    <small className="text-light fw-medium">Heading 4</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td>
                    <small className="text-light fw-medium">Heading 5</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td>
                    <small className="text-light fw-medium">Heading 6</small>
                  </td>
                  <td className="py-3">
        ...
        <div className="col-lg">
          <div className="card mb-4">
            <h5 className="card-header">
              Customizing Headings{' '}
              <small className="text-muted ms-1">Default</small>
            </h5>
            <table className="table table-borderless">
              <tbody>
                <tr>
                  ...
                  <td className="py-3">
                    <h1 className="mb-0">
                      Bootstrap <small className="text-muted">heading</small>
                    </h1>
                  </td>
                </tr>
                <tr>
          ...
          <div className="card mb-4">
            ...
            <table className="table table-borderless">
              <tbody>
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Display 1</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Display 2</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Display 3</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Display 4</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Display 5</small>
                  </td>
                  <td className="py-3">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Display 6</small>
                  </td>
                  <td className="py-3">
          ...
          <div className="card mb-4">
            ...
            <table className="table table-borderless">
              <tbody>
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Paragraph</small>
                  </td>
                  <td className="py-3">
                    <p className="mb-0">
                      Vivamus sagittis lacus vel augue laoreet rutrum faucibus
                      dolor auctor. Duis mollis, est non commodo luctus. Duis
                      mollis, est non commodo luctus.Duis mollis, est non
                      commodo luctus.
                    </p>
                  </td>
                </tr>
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Lead Text</small>
                  </td>
                  <td className="py-4">
                ...
                <tr>
                  <td className="align-middle">
                    <small className="text-light fw-medium">Muted text</small>
                  </td>
                  <td className="py-3">
            ...
            <div className="card-body">
              <table className="table table-borderless">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <small className="text-light fw-medium">Addition</small>
                    </td>
                    <td className="py-3">
                      <p className="mb-0">
                        <ins>
                  ...
                  <tr>
                    <td>
                      <small className="text-light fw-medium">Underlined</small>
                    </td>
                    <td className="py-3">
                      <p className="mb-0">
                  ...
                  <tr>
                    <td>
                      <small className="text-light fw-medium">Fine Print</small>
                    </td>
                    <td className="py-3">
                      <p className="mb-0">
                        <small>
                  ...
                  <tr>
                    <td>
                      <small className="text-light fw-medium">Bold Text</small>
                    </td>
                    <td className="py-3">
                      <p className="mb-0">
