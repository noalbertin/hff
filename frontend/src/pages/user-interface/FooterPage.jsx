  ...
  return (
    <>
      <h4 className="py-3 mb-4">
        <span className="text-muted fw-light">UI elements /</span> Footer
      </h4>
        ...
        <footer className="footer bg-light">
          <div className="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
            ...
            <div>
              ...
              <a aria-label="go to help" href="#" className="footer-link me-4">
                Help
              </a>
              <a
            ...
            <div>
              ...
              <div className="dropdown dropup footer-link me-3">
                ...
                <div className="dropdown-menu dropdown-menu-end">
                  <a
                    aria-label="dropdown link currency"
              ...
              >
                <i className="bx bx-log-out-circle me-1"></i>Logout
              </a>
            </div>
          </div>
        </footer>
