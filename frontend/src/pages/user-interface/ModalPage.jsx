  ...
  return (
    <>
      <h4 className="py-3 mb-4">
        <span className="text-muted fw-light">UI elements /</span> Modals
      </h4>
                ...
                >
                  <div className="modal-dialog">
                    <form className="modal-content">
                      <div className="modal-header">
                        <h5 className="modal-title" id="modalTopTitle">
                          Modal title
                        </h5>
                        <button
                          aria-label="Click me"
                      ...
                      <div className="modal-body">
                        ...
                        <div className="row g-2">
                          ...
                          <div className="col mb-0">
                            <label htmlFor="dobSlideTop" className="form-label">
                              DOB
                            </label>
                            <input
                              type="date"
                ...
                <div className="modal-dialog modal-sm" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      ...
                      <div className="row g-2">
                        <div className="col mb-0">
                          <label className="form-label" htmlFor="emailSmall">
                            Email
                          </label>
                          <input
                            type="email"
                        ...
                        <div className="col mb-0">
                          <label htmlFor="dobSmall" className="form-label">
                            DOB
                          </label>
                          <input
                            id="dobSmall"
                ...
                <div className="modal-dialog modal-xl" role="document">
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <div className="row">
                        <div className="col mb-3">
                          <label htmlFor="nameExLarge" className="form-label">
                            Name
                          </label>
                          <input
                            type="text"
                      ...
                      <div className="row g-2">
                        <div className="col mb-0">
                          <label htmlFor="emailExLarge" className="form-label">
                            Email
                          </label>
                          <input
                            type="email"
                        ...
                        <div className="col mb-0">
                          <label htmlFor="dobExLarge" className="form-label">
                            DOB
                          </label>
                          <input
                            type="date"
                    ...
                    <form className="modal-content">
                      ...
                      <div className="modal-body">
                        ...
                        <div className="row g-2">
                          ...
                          <div className="col mb-0">
                            <label htmlFor="dobBackdrop" className="form-label">
                              DOB
                            </label>
                            <input
                              type="date"
