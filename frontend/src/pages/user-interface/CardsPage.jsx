  ...
  return (
    <div className="container-xxl flex-grow-1 container-p-y">
      <h4 className="py-3 mb-4">
        <span className="text-muted fw-light">UI Elements /</span> Cards Basic
      </h4>
        ...
        <div className="col-md-6 col-lg-4 mb-3">
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <a aria-label="card link" href="#" className="card-link">
                Card link
              </a>
              <a aria-label="card link" href="#" className="card-link">
                Another link
        ...
        <div className="col-md-6 col-lg-4 mb-3">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <a aria-label="card link" href="#" className="btn btn-primary">
                Go somewhere
              </a>
            </div>
          </div>
        ...
        <div className="col">
          <div className="card h-100">
            <img
              aria-label="card image"
              className="card-img-top"
              src="../assets/img/elements/19.jpg"
              alt="Card image cap"
            />
            <div className="card-body">
              <h5 className="card-title">Card title</h5>
        ...
        <div className="col">
          <div className="card h-100">
            <img
              aria-label="card image"
              className="card-img-top"
              src="../assets/img/elements/20.jpg"
              alt="Card image cap"
            />
            <div className="card-body">
              <h5 className="card-title">Card title</h5>
