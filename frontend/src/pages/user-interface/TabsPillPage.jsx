  ...
  return (
    <>
      <h4 className="py-3 mb-4">
        <span className="text-muted fw-light">UI elements /</span> Tabs & Pills
      </h4>
            ...
            <div className="tab-content">
              ...
              >
                <p>
                  ...
                  caramels cake caramels sesame snaps powder. Bear claw candy
                  topping.
                </p>
                <p className="mb-0">
                  Tootsie roll fruitcake cookie. Dessert topping pie. Jujubes
                  wafer carrot cake jelly. Bonbon jelly-o jelly-o ice cream
                  jelly beans candy canes cake bonbon. Cookie jelly beans
                  marshmallow jujubes sweet.
                </p>
              </div>
              <div
              ...
              >
                <p>
                  ...
                  roll muffin biscuit icing dessert gingerbread. Pastry ice
            ...
            <ul className="nav nav-tabs nav-fill" role="tablist">
              <li className="nav-item">
                <button
                  ...
                  aria-selected="true"
                >
                  <i className="tf-icons bx bx-home me-1"></i>
                  <span className="d-none d-sm-block"> Home</span>
                  <span className="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-danger ms-1">
                    3
                  </span>
                </button>
              </li>
              <li className="nav-item">
                <button
                  ...
                  aria-selected="false"
                >
                  <i className="tf-icons bx bx-user me-1"></i>
