              ...
              position(t) {
                ...
                if ('manual' != e.position) {
                  var i,
                    ...
                    v = m.clientHeight,
                    f =
                      Math.max(m.clientWidth || 0, window.innerWidth || 0) > 480
                        ? e.position
                        : 'all',
                    T = this.DOM['input' == f ? 'input' : 'scope']
                  if (
                    ((t = t || g.clientHeight), this.state.dropdown.visible)
                  ) {
                    if (
                      ('text' == f
                        ? ((a = (i = (function () {
                    ...
                    ;(s = Math.floor(s)),
                      (a = Math.ceil(a)),
                      (d =
                        ((l = e.placeAbove ?? v - i.bottom < t) ? s : a) + u),
                      (h = `left: ${
                        n + ((p && i.width) || 0) + window.pageXOffset
                      }px;`),
                        ...
                        switch (t.key) {
                          ...
                          case 'Up':
                            ...
                            i && (i = this.dropdown.getNextOrPrevOption(i, !r)),
                              (i &&
                                i.matches(e.classNames.dropdownItemSelector)) ||
                                (i = o[r ? o.length - 1 : 0]),
                          ...
                          case 'Tab': {
                            let n =
                              !e.autoComplete.rightKey || !e.autoComplete.tabKey
                            if (!a && i && n && !this.state.editing) {
                              t.preventDefault()
                              var l = this.dropdown.getMappedValue(s)
                              return (
                                this.input.autocomplete.set.call(this, l), !1
                              )
                            }
                            return !0
                          }
                                ...
                                .then(() => {
                                  if (i)
                                    return (
                                      ...
                                      (i = this.dropdown.getNextOrPrevOption(
                                        i,
                                        !r
                                      )),
                ...
                return g([], t)
                  .map((t, i) => {
                    ...
                    return (
                      (s =
                        'string' == typeof s &&
                        this.settings.dropdown.escapeHTML
                          ? d(s)
                          : s),
                      ...
                      t.addedNodes.forEach((t) => {
                        if ('<div><br></div>' == t.outerHTML)
                          ...
                          if (
                            ...
                            (t.previousSibling && !T(t.previousSibling)) ||
                              t.before('​')
                      }),
                ...
                input: {
                  ...
                  normalize(t, e) {
                    ...
                    i.childNodes.forEach(
                      (t) => 3 == t.nodeType && s.push(t.nodeValue)
                    ),
                      (s = s.join('\n'))
                    try {
                      s = s.replace(
                    ...
                    return (
                      (s = s.replace(/\s/g, ' ')), e?.trim ? this.trim(s) : s
                    )
                  },
                  autocomplete: {
                    suggest(t) {
