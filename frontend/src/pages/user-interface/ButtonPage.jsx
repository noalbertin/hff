            ...
            <div className="card-body">
              ...
              <div className="demo-inline-spacing">
                {[
                  ...
                  <Button key={index} type={type} rounded>
                    {type.charAt(0).toUpperCase() + type.slice(1)}
                  </Button>
                ))}
              </div>
            ...
            <div className="card-body">
              ...
              <div className="demo-inline-spacing">
                {[
                  ...
                  <Button key={index} outline type={type}>
                    {type.charAt(0).toUpperCase() + type.slice(1)}
                  </Button>
                ))}
              </div>
            ...
            <div className="card-body">
              ...
              <div className="demo-inline-spacing">
                {[
                  ...
                  <Button key={index} type={type} rounded outline>
                    {type.charAt(0).toUpperCase() + type.slice(1)}
                  </Button>
                ))}
              </div>
              ...
              <div className="col-md-6 col-lg-4">
                ...
                <div className="demo-inline-spacing">
                  <Button type="Button" className="btn btn-primary">
                    <span className="tf-icons bx bx-pie-chart-alt me-1"></span>
                    Primary
                  </Button>
      ...
      <div className="col-12">
        <div className="card mb-4">
          ...
          <div className="card-body">
            ...
            <div className="demo-inline-spacing">
              <Button type="primary" state="">
                Normal
              </Button>
              <Button type="primary" state="active">
                Active
              </Button>
