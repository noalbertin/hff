  ...
  return (
    <div className="container-xxl flex-grow-1 container-p-y">
      <h4 className="py-3 mb-4">
        <span className="text-muted fw-light">UI elements /</span> Offcanvas
      </h4>
        ...
        <div className="card-body">
          <div className="row gy-3">
            ...
            <div className="col-lg-3 col-md-6">
              <small className="text-light fw-medium mb-3">
                Start (Default)
              </small>
              <div className="mt-3">
                <button
          ...
          <div className="row gy-3">
            ...
            <div className="col-lg-4 col-md-6">
              ...
              <div className="mt-3">
                ...
                >
                  <div className="offcanvas-header">
                    <h5 id="offcanvasScrollLabel" className="offcanvas-title">
                      Offcanvas Scroll
                    </h5>
                    <button
                      type="button"
